...
doc_events = {
    ...
    "Article": {
        "on_update": "library_management.library_management.doctype.article.article.article_hook",
        "on_submit": "library_management.library_management.doctype.article.article.article_hook",
    },
    "Item": {
        "validate": "library_management.library_management.doc_events.item.validate_item"
    }
}
